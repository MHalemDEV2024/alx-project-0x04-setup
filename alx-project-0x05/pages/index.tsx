  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center text-center pt-32">
      ...
      <div className="flex gap-6">
        ...
        <Button action={() => routeToNextPage({ pageRoute: '/contact-us' })} buttonLabel="Contact Us" buttonBackgroundColor="orange" />
        <Button action={() => routeToNextPage({ pageRoute: '/counter-app' })} buttonLabel="Counter App" buttonBackgroundColor="purple" />
      </div>
    </div>
  );
}
